...
while(True):
    ...
    for i in range(nums[0]):
        ...
        if int(classes[0][i] == 67):
            item_type = "Mobile detected time"
            timestamp = datetime.datetime.now().strftime("%d-%m-%Y %H:%M:%S")
            if item_type  not in detected_objects:
            #     detected_objects.append("Mobile Phone detected")
            
                
                detected_objects[item_type]=[timestamp]
            else:
                
                detected_objects[item_type].append(timestamp)


            # detected_objects.append("Mobile Phone detected")
            # timestamp = datetime.datetime.now().strftime("%d-%m-%Y %H:%M:%S")
            print('Mobile Phone detected at', timestamp)    
            # print('Mobile Phone detected')
        if int(classes[0][i] == 73):
            item_type = "Book detected time"
            timestamp = datetime.datetime.now().strftime("%d-%m-%Y %H:%M:%S")
            if item_type  not in detected_objects:
            #     detected_objects.append("Mobile Phone detected")
            ...
            # detected_objects.append("Mobile Phone detected")
            # timestamp = datetime.datetime.now().strftime("%d-%m-%Y %H:%M:%S")
            print('Book detected at', timestamp) 
          

    # Save detected_objects to a file
    if detected_objects:
        ...
        print("Unauthorized objects detected:")
        print("-----------------------------")
        for obj in detected_objects:
            print(obj)
        print("Check detected_objects.json for details.")
    else:
        print("No unauthorized objects detected") 
...
#     print("No unauthorised object detected")
# else:
#     print("un authorised object detected:")  
